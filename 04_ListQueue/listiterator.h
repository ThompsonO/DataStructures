/*
  ...
  Constructor: ListIterator(Node<generic>* n)
  Points m_current to n.

    Parameters:
    n - The data item which m_current should point to.
  ...
  Operator: ListIterator operator--()
  A pre-increment operator that moves the iterator to the previous data item. If
  the iterator has already surpassed the first data item, then the function
  does nothing.

    Returns:
    A copy of an iterator located at the previous data item.

  Operator: ListIterator operator--(int x)
  A post-increment operator that moves the iterator to the previous data item.If
  the iterator has already surpassed the first data item, then the function
  does nothing.
